...
<body class="body-veranstaltungen">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="veranstaltungen.php">Veranstaltungen</a>
        </li>
        <li class="nav-item">
  ...
  <div class="card text-center">
    <div class="card-header ">
      <ul class="nav nav-tabs card-header-tabs " id="myTab">
          <li class="nav-item">
            <a href="#infos_va" class="nav-link active" data-bs-toggle="tab">Informationen zu Veranstaltungen</a>
          </li>  
          <li class="nav-item">
            <a href="#reservierung_va" class="nav-link" data-bs-toggle="tab">Ihre Reservierung</a>
          </li>
      </ul>
    </div>
    <div class="card-body ">
      <div class="tab-content">
        <div class="tab-pane active fade show" id="infos_va">
        ...
        <div class="tab-pane fade show" id="reservierung_va">
        <h5 class="card-title"> HOHO</h5>
            ...
            <form class="form-control">    
              <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1" name="name_va">
                  </div>

                  <div class="input-group mb-3">
                    <input type="date" class="form-control" placeholder="datum" aria-label="Recipient's username" aria-describedby="basic-addon2" name="datum_va">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="anzahl_va">
                  </div>

                  <div class="input-group mb-3">
                    <span class="input-group-text">Rückrufnummer</span>
                    <input type="text" class="form-control" aria-label="Telefonnummer" name="phone_va">
                  </div>
                  <div class="input-group mb-3">
                  <span class="input-group-text">@</span>
                    <input type="text" class="form-control" placeholder="email" aria-label="email" name="email_va">
                  </div>

                  <div class="input-group">
                    <span class="input-group-text">Anmerkungen</span>
                    <textarea class="form-control" aria-label="With textarea" name="notes_va"></textarea>
                  </div>
