    ...
    <div class="card-header ">
      <ul class="nav nav-tabs card-header-tabs " id="myTab">
         ...
         <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="#wochenkarte" class="nav-link disabled" data-bs-toggle="tab">Wochenkarte</a>
          </li>
          <li class="nav-item">
            <a href="#sommerkarte" class="nav-link disabled" data-bs-toggle="tab">Sommerkarte</a>
          </li>
          <li class="nav-item">
            <a href="#grillkarte" class="nav-link disabled" data-bs-toggle="tab">Grillkarte</a>
          </li>
          <li class="nav-item">
